...
export const CircularTestimonials = ({
  ...
  return (
    <div className={`w-full max-w-7xl mx-auto p-8 ${className}`}>
      <div className="grid gap-12 md:gap-24 md:grid-cols-2 items-center">
        {/* Images */}
        <div 
        ...
        <div className="flex flex-col justify-center h-full">
          ...
          <div className="flex gap-4 mt-10">
            <button
              className="w-14 h-14 rounded-full flex items-center justify-center transition-all duration-300 hover:scale-105 active:scale-95 shadow-lg"
              onClick={handlePrev}
              style={{
